<template>
  <div class="block py-1 rounded-md text-base font-medium text-copy-primary focus:outline-none focus:text-copy-primary focus:bg-gray-700">
    ...
    <div class="relative">
      <input
        ...
        class="bg-background-form border border-gray-500 rounded-full px-4 pl-10 py-1 outline-none focus:border-blue-500"
        v-model="query"
        @input="softReset"
        @keyup="performSearch"
    ...
    <transition name="fade">
      <div
        ...
        class="normal-case absolute border w-50 text-left mb-4 mt-2 rounded-lg shadow overflow-hidden z-10 overflow-y-auto"
        style=""
